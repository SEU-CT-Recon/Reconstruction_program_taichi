            ...
            for i_z in ti.ndrange(img_dim_z):
                ...
                for j in ti.ndrange(view_num):
                    ...
                    if cone_beam == True:
                        ...
                        if temp_v_idx_floor < -1 or temp_v_idx_floor + 1 > det_elem_count_vertical_actual: #mark
                            img_recon_taichi[i_z, i_y, i_x] += 0
                            #break
                        else:
                            ...
                            elif temp_v_idx_floor == det_elem_count_vertical_actual-1: #huashi
                                part_1 = 0
                                part_0 = img_sgm_filtered_taichi[det_elem_count_vertical_actual-1,j,temp_u_idx_floor] * (1 - ratio_u) + \
                                    img_sgm_filtered_taichi[det_elem_count_vertical_actual-1,j,temp_u_idx_floor + 1] * ratio_u
                                img_recon_taichi[i_z, i_y, i_x] += (source_isocenter_dis * distance_weight) * \
                                    ((1 - ratio_v) * part_0 + ratio_v * part_1) * delta_angle * div_factor
                            else:
